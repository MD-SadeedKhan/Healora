...
const Landing = () => {
  ...
  const slides = [
    "https://i.pinimg.com/736x/f2/1a/37/f21a37f9ee61cc531882725113e99213.jpg",
  ...
  return (
    <div className="min-h-screen font-['Manrope',sans-serif]">
          ...
          <nav className="flex items-center space-x-2 md:space-x-4">
            {[
              ...
              },
              {
                ...
                path: user ? "/ai-assistant" : "/register", // Redirect to register if not logged in
              },
              {
                ...
                path: user ? "/medicine-search" : "/register", // Redirect to register if not logged in
              },
              {
                name: "Hospitals",
                icon: (
                ...
                path: user ? "/hospitals" : "/register", // Redirect to register if not logged in
              },
            ].map((link) => (
              <Link
                key={link.name}
                to={link.path}
                className="group flex items-center space-x-2 px-4 py-2 text-[#0D1B2A] hover:text-[#5AC8FA] hover:scale-105 transition-all duration-200 text-lg font-medium rounded-full hover:bg-white/30"
              >
                {link.icon}
                <span>{link.name}</span>
              </Link>
            ...
            <div className="flex space-x-2">
              {user ? (
                <>
                  <Link
                    to="/dashboard"
                    className="px-4 py-2 bg-transparent border border-[#000000] text-[#0a0a0a] hover:bg-[#5AC8FA] hover:text-white rounded-full text-base font-medium transition-all duration-200 hover:scale-105"
                  >
                    Dashboard
                  </Link>
                  <button
      ...
      <section
        ...
        style={{
          backgroundImage: 'url("background.jpeg")', // Replace this URL with your actual hero background image URL
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 animate-fade-in-left">
              <div className="space-y-6">
                <span className="inline-flex items-center px-4 py-2bg-[#A4B5C4]/40 text-[#2A114B] border-[#A4B5C4]/30 rounded-lg text-sm font-bold shadow-sm">
                  <svg
                ...
                <h1 className="text-6xl lg:text-7xl font-bold leading-tight font-['Sora',sans-serif] text-[#2A114B] tracking-tight drop-shadow-lg">
                  Your AI-Powered
                  <span className="bg-gradient-to-r from-[#40C4B6] drop-shadow-md to-[#0d5258] bg-clip-text text-transparent block text-6xl lg:text-7xl ... bg-black/20 px-4 py-2 rounded-lg">
                    Health Companion
                  </span>
                </h1>
                <p className="text-lg text-[#2a1a31] font-semibold leading-relaxed max-w-xl drop-shadow-md">
                  Get instant medical insights, symptom analysis, and
                  personalized health guidance powered by advanced AI
                  technology. Available 24/7 for your peace of mind.
                </p>
              </div>
              <div className="flex items-center space-x-8 text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-bold text-[#223342] drop-shadow-sm">
                    Users
                  </span>
                  <span className="font-bold text-[#222f3b] drop-shadow-sm">
                    50,000+ users
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-bold text-[#344758] drop-shadow-sm">
                    Star
                  </span>
                  <span className="font-bold text-[#34495b] drop-shadow-sm">
                    4.9/5 rating
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-bold text-[#394d5f] drop-shadow-sm">
                    Availability
                  </span>
                  <span className="font-bold text-[#354655] drop-shadow-sm">
                    24/7 Available
                  </span>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <button className="text-lg px-8 py-3 border-2 bg-gradient-to-r from-[#8c5ea2] to-[#905fbb] border-[#A4B5C4] text-[#fefcff] hover:bg-[#A4B5C4] hover:text-[#2A114B] rounded-xl transition font-medium drop-shadow-sm">
                    <svg
              ...
              <div className="pt-2">
                ...
                <div className="flex items-center space-x-8">
                  <div className="text-sm font-bold text-[#3a2e49] drop-shadow-xl">
                    MedCenter+
                  </div>
                  <div className="text-sm font-bold text-[#3e344b] drop-shadow-xl">
                    HealthFirst
                  </div>
                  <div className="text-sm font-bold text-[#3e334d] drop-shadow-xl">
                    CareNet
                  </div>
                  <div className="text-sm font-bold text-[#352d43] drop-shadow-xl">
                    WellnessHub
                  </div>
                </div>
              </div>
              ...
              <div className="relative w-full max-w-[610px] mx-auto">
                <div className="relative h-[460px] rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 text-white">
                    <h3 className="text-2xl font-bold font-['Sora',sans-serif] tracking-tight">
                      {currentSlide === 0
      ...
      {/* Features Section */}
      <section id="features" className="py-24 bg-[#F5F7FA] shadow-sm">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 animate-fade-in-up">
            <h2 className="text-5xl font-bold mb-6 font-['Sora',sans-serif] text-[#2A114B] tracking-tight">
              Powerful Features for Your Health
            </h2>
            <p className="text-lg text-[#2d363d] max-w-3xl mx-auto leading-relaxed">
              Healora combines cutting-edge AI technology with medical expertise
              to provide comprehensive health assistance tailored to your unique
              needs.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
                ...
                links: [
                  {
                    ...
                    icon: (
                      <svg
                        className="w-6 h-6 !text-[#2A114B] !stroke-current group-hover:!text-white transition-colors"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                        strokeWidth="2"
              ...
              },
              {
                ...
                links: [
                  {
                    href: "https://example.com/health-monitoring",
                    icon: (
                      <svg
                        className="w-6 h-6 !text-[#2A114B] !stroke-current group-hover:!text-white transition-colors"
                        fill="none"
              ...
              },
              {
                ...
                links: [
                  {
                    href: "https://example.com/ai-consultation",
                    icon: (
                      <svg
                        className="w-6 h-6 !text-[#2A114B] !stroke-current group-hover:!text-white transition-colors"
                        fill="none"
              ...
              },
              {
                ...
                links: [
                  {
                    href: "https://example.com/instant-results",
                    icon: (
                      <svg
                        className="w-6 h-6 !text-[#2A114B] !stroke-current group-hover:!text-white transition-colors"
                        fill="none"
              ...
              },
              {
                ...
                links: [
                  {
                    href: "https://example.com/mobile-ready",
                    icon: (
                      <svg
                        className="w-6 h-6 !text-[#2A114B] !stroke-current group-hover:!text-white transition-colors"
                        fill="none"
              ...
              >
                ...
                <h3 className="text-2xl font-bold font-['Sora',sans-serif] mb-2 group-hover:text-white tracking-tight">
                  {feature.title}
                </h3>
                <p className="text-base leading-relaxed text-[#2A114B] group-hover:text-white/90">
                  {feature.description}
                </p>
                <div className="flex space-x-4 mt-4 opacity-100">
          ...
          <div className="flex justify-center mt-12 space-x-6">
            {[
              ...
              <div key={badge} className="flex items-center space-x-2">
                ...
                <span className="text-[#2A114B] text-sm font-medium">
                  {badge}
                </span>
              </div>
            ))}
      ...
      <section id="how-it-works" className="py-24 bg-[#FFFFFF] shadow-sm">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-24 animate-fade-in-up">
            <span className="inline-flex items-center mb-6 text-base px-4 py-2 bg-[#A4B5C4]/10 text-[#0D1B2A] border-[#A4B5C4]/20 rounded-lg">
              How It Works
            </span>
            <h2 className="text-5xl font-bold mb-6 font-['Sora',sans-serif] text-[#0D1B2A] tracking-tight">
              Simple Steps to Better Health
            </h2>
            <p className="text-lg text-[#34495E] max-w-3xl mx-auto leading-relaxed">
              Getting health insights with Healora is as easy as having a
              conversation. Our AI guides you through each step of your health
              journey.
            </p>
          </div>
            ...
            {[
              ...
              <div key={index} className="text-center relative">
                <div className="relative mb-8">
                  <div className="w-28 h-28 bg-gradient-to-br from-[#40C4B6] to-[#006D77] rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                    {step.icon}
                  </div>
                  <span className="absolute -top-2 -right-2 bg-white border-2 border-[#40C4B6] font-bold text-[#40C4B6] px-4 py-2 rounded-full">
                    {step.step}
                  </span>
                  {index < 2 && (
                    <div className="hidden md:block absolute top-16 left-full w-full h-1 bg-gradient-to-r from-[#40C4B6] to-[#006D77] transform translate-x-4">
                      <svg
                        className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-2 w-8 h-8 text-[#006D77]"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                        strokeWidth="3"
                ...
                <h3 className="text-3xl font-bold mb-4 text-[#0D1B2A] font-['Sora',sans-serif] tracking-tight">
                  {step.title}
                </h3>
      ...
      <section id="testimonials" className="py-24 bg-[#F5F7FA]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 animate-fade-in-up">
            ...
            <p className="text-lg text-[#334351] max-w-3xl mx-auto leading-relaxed">
              See what doctors, nurses, and healthcare managers are saying about
              their experience with Healora.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-[#FFFFFF] p-8 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden"
              >
                <svg
                  className="w-10 h-10 text-[#40C4B6]/30 mb-6"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <div className="flex mb-6">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <svg
                      key={i}
                      className="w-6 h-6 fill-[#FFD700] text-[#FFD700] group-hover:scale-110 transition-transform"
                      viewBox="0 0 24 24"
                    >
                      <path d="M12 .587l3.668 7.431 8.2 1.192-5.934 5.783 1.4 8.162L12 18.897l-7.334 3.858 1.4-8.162L.132 9.21l8.2-1.192L12 .587z" />
                    </svg>
                ...
                <p className="text-base text-[#34495E] mb-8 leading-relaxed">
                  "{testimonial.content}"
                </p>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#40C4B6] to-[#006D77] rounded-full flex items-center justify-center text-white font-bold">
                    {testimonial.image}
                  </div>
                  <div>
                    <div className="font-bold text-[#2A114B] text-lg font-['Sora',sans-serif] tracking-tight">
                      {testimonial.name}
                    </div>
      ...
      <section id="security" className="py-24 bg-[#FFFFFF] shadow-sm">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 animate-fade-in-up">
            <span className="inline-flex items-center mb-6 text-base px-4 py-2 bg-[#A4B5C4]/10 text-[#2A114B] border-[#A4B5C4]/20 rounded-lg">
              Trust & Security
            </span>
            <h2 className="text-5xl font-bold mb-6 font-['Sora',sans-serif] text-[#2A114B] tracking-tight">
            ...
            <p className="text-lg text-[#34495E] max-w-3xl mx-auto leading-relaxed">
              ...
              protect your sensitive health information with enterprise-grade
              protection.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {[
              ...
              <div key={index} className="text-center">
                ...
                <h3 className="text-2xl font-bold font-['Sora',sans-serif] mb-2 text-[#2A114B] tracking-tight">
                  {item.title}
                </h3>
      ...
      {/* Statistics Section */}
      <section id="statistics" className="py-24 bg-[#F5F7FA]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 animate-fade-in-up">
            <h2 className="text-5xl font-bold mb-6 font-['Sora',sans-serif] text-[#2A114B] tracking-tight">
              Impacting Lives Globally
            </h2>
            <p className="text-lg text-[#273643] max-w-3xl mx-auto leading-relaxed">
              Healora is trusted by thousands worldwide, delivering meaningful
              health insights and improving lives every day.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div key={index} className="text-center">
                ...
                <h3 className="text-5xl font-bold text-[#2A114B] font-['Sora',sans-serif] mb-2 tracking-tight">
                  {stat.value}
                </h3>
                <p className="text-lg text-[#A4B5C4]">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section
        id="cta"
        className="py-24 bg-gradient-to-r from-[#40C4B6] to-[#006D77] text-white"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-5xl font-bold mb-6 font-['Sora',sans-serif] animate-fade-in-up tracking-tight">
            Take Control of Your Health Today
          </h2>
          <p className="text-lg mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-in-up">
            Join thousands of users who trust Healora for smarter, faster, and
            more secure health insights. Your journey to better health starts
            here.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-up">
            <Link to={user ? "/dashboard" : "/register"}>
              <button className="text-lg px-8 py-3 bg-[#FFFFFF] text-[#2A114B] rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 font-medium">
                Get Started Now
                <svg
                  className="ml-2 h-5 w-5 inline"
                  fill="none"
            ...
            <Link to="/contact-us">
              {" "}
              {/* Changed from /contact to /contact-us */}
              <button className="text-lg px-8 py-3 border-2 border-[#FFFFFF] text-[#FFFFFF] hover:bg-[#A4B5C4] hover:border-[#A4B5C4] hover:text-[#2A114B] rounded-xl transition font-medium">
                Contact Us
                <svg
                  className="ml-2 h-5 w-5 inline"
                  fill="none"
      ...
      <footer className="bg-[#2A114B] text-white py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-base text-[#A4B5C4] leading-relaxed">
                Empowering your health with AI-driven insights and personalized
                care, available 24/7.
              </p>
            </div>
            <div>
              <h4 className="text-xl font-bold font-['Sora',sans-serif] mb-4 tracking-tight">
                Quick Links
              </h4>
              <ul className="space-y-2">
                {["Dashboard", "AI Assistant", "Medicine Search", "Hospitals"].map(
                  (link) => (
                    <li key={link}>
                      <Link
                        to={`/${link.toLowerCase().replace(" ", "-")}`}
                        className="text-base text-[#A4B5C4] hover:text-[#5AC8FA] transition-colors"
                      >
                        {link}
                      </Link>
                    </li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["FAQ", "Privacy Policy", "About Us", "Support Center"].map(
                  (link) => (
                    <li key={link}>
                      <Link
                        to={`/${link.toLowerCase().replace(" ", "-")}`}
                ...
                {[
                  {
                    ...
                    url: "https://x.com/SadeedKhan42070?t=8_R_-uGMlNh2pK1i9EKU7Q&s=08",
                  },
                  {
                    name: "Facebook",
                    icon: (
                    ...
                    url: "https://www.facebook.com/share/1AnHpoRyP8/",
                  },
                  {
                    name: "Instagram",
                    icon: (
                    ...
                    url: "https://www.instagram.com/yooo_sadeed?igsh=MXBhcXNkZHpkYXU4cA==",
                  },
                ].map((social) => (
                  <a
                    key={social.name}
          ...
          <div className="mt-12 pt-8 border-t border-[#A4B5C4]/20 flex flex-col md:flex-row justify-between items-center">
            <p className="text-base text-[#A4B5C4]">
            ...
            <div className="flex space-x-4 mt-4 md:mt-0">
              ...
              <Link
                to="/about-us" // Replaced "Blog" with "About Us"
                className="text-base text-[#A4B5C4] hover:text-[#5AC8FA] transition-colors"
              >
                About Us
              </Link>
